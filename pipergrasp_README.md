# PiperGrasp: LLM-Enhanced Robotic Grasp Detection

> **饶张柏** | 福州大学 · 电子信息  
> 将大语言模型与机器人抓取感知深度融合，探索"感知-推理-执行"智能闭环

---

## 项目简介

PiperGrasp 基于 GraspNet-1Billion (CVPR 2020) 基线模型，在深度学习抓取检测的基础上，引入大语言模型（LLM）构建智能交互前端，实现从视觉感知到自然语言推理再到抓取决策的端到端闭环。
